<template>
    <div class="page home-page flex flex-column">
        <section class="relative inner-container head-section flex flex-center mb-5">
            <div class="titles-wrapper flex flex-column w-100-vw">
                <h1
                    ref="titleOne"
                    class="title title-one flex uppercase"
                ></h1>
                <h1
                    ref="titleTwo"
                    class="title title-two flex uppercase"
                ></h1>
                <h1
                    ref="titleThree"
        ...
        <section class="inner-container quote-section mt-5 mb-5">
            <p class="txt-lg mb-4">
                ...
                <span class="is-brown">unique experience</span>, getting into web development changed a lot of things for me, and since then i try to push my work to new horizons with each project,
                always putting <span class="is-brown">quality</span> first.
            </p>
            <p class="txt-lg mb-4">
                All this is just the beginning, and i can`t wait to push it event further by working with you on your
            ...
            <p class="txt-lg mb-4">
                <span class="is-brown">PASSIONATE</span> ABOUT WEB TECHNOLOGIES. I LOVE WORKING AT THE INTERSECTION OF CREATIVITY AND USER FRIENDLY INTERFACES.
                <span class="is-brown">I CREATE MEMORABLE</span> WEB EXPERIENCES.
            </p>
        ...
        <section class="contact-section mt-5 flex flex-center flex-column pt-5">
            ...
            <footer class="page-footer w-100 py-3 mt-5">
                <div class="inner-container flex jcsb">
                    <p>Copyright &copy; {{ new Date().getFullYear() }} / Folio v.1</p>
...
<script setup>
    ...
    onMounted(async () => {
        ...
        if (store.isInitialLoading) {
            await animations.homepage.initial(store);
